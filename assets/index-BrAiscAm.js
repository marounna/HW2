 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class er{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return S(this._path)?null:ol(this._path)}get ref(){return new We(this._repo,this._path)}get _queryIdentifier(){const e=ao(this._queryParams),t=Es(e);return t==="{}"?"default":t}get _queryObject(){return ao(this._queryParams)}isEqual(e){if(e=G(e),!(e instanceof er))return!1;const t=this._repo===e._repo,i=Ss(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+Fd(this._path)}}class We extends er{constructor(e,t){super(e,t,new As,!1)}get parent(){const e=ll(this._path);return e===null?null:new We(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Qn{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new P(e),i=tn(this.ref,e);return new Qn(this._node.getChild(t),i,D)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Qn(s,tn(this.ref,i),D)))}hasChild(e){const t=new P(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function en(n,e){return n=G(n),n._checkNotDeleted("ref"),e!==void 0?tn(n._root,e):n._root}function tn(n,e){return n=G(n),C(n._path)===null?I_("child","path",e):$l("child","path",e),new We(n._repo,B(n._path,e))}function G_(n,e){n=G(n),Ks("push",n._path),Wl("push",e,n._path,!0);const t=zl(n._repo),i=V_(t),s=tn(n,i),r=tn(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function K_(n){return Ks("remove",n._path),Jl(n,null)}function Jl(n,e){n=G(n),Ks("set",n._path),Wl("set",e,n._path,!1);const t=new ni;return O_(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}class tr{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const i=t._queryParams.getIndex();return new z_("value",this,new Qn(e.snapshotNode,new We(t._repo,t._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new j_(this,e,t):null}matches(e){return e instanceof tr?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Q_(n,e,t,i,s){const r=new q_(t,void 0),o=new tr(r);return D_(n._repo,n,o),()=>L_(n._repo,n,o)}function nr(n,e,t,i){return Q_(n,"value",e)}Qf(We);t_(We);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _c="storage";function fm(n,e,t){return n=G(n),om(n,e,t)}function _m(n){return n=G(n),am(n)}function pm(n,e){return n=G(n),hm(n,e)}function pc(n=ri(),e){n=G(n);const i=si(n,_c).getImmediate({identifier:e}),s=Ca("storage");return s&&mm(i,...s),i}function mm(n,e,t,i={}){dm(n,e,t,i)}function gm(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),i=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new ar(t,i,s,e,lt)}function vm(){tt(new Ue(_c,gm,"PUBLIC").setMultipleInstances(!0)),fe(No,Ao,""),fe(No,Ao,"esm2017")}vm();var ym="firebase",wm="10.12.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rg(n,e,t=!1){if(ve(n.app))return Promise.reject(Xe(n));const i="signIn",s=await Dc(n,i,e),r=await Ct._fromIdTokenResponse(n,i,s);return t||await n._updateCurrentUser(r.user),r}function og(n,e,t,i){return G(n).onIdTokenChanged(e,t,i)}function ag(n,e,t){return G(n).beforeAuthStateChanged(e,t)}const Zn="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
